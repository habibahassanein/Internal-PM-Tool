"""
Ibn Battouta MCP Server (Optimized)
Simplified structure using shared tool registry and dispatcher.

Changes from original:
- Tool definitions extracted to src/core/tool_registry.py
- Tool dispatch logic extracted to tool_dispatcher.py
- OAuth endpoints remain inline (complex, rarely modified)
- Result: 674 lines → ~400 lines (40% reduction)
"""
